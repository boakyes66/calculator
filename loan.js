...
function calculateResults(){
    ...
    const monthly = (principle * x * calculatedInterest) / (x )/12;
...
function ra(){
				if($("#typee").val()==1)
						{$("#interest").val(48),$("#up").val(3.5);}
				if($("#typee").val()==2)
						{$("#interest").val(24),$("#up").val(2);}
				if($("#typee").val()==3)
						{$("#interest").val(24),$("#up").val(1);}
						
				if($("#typee").val()==4)
					{$("#interest").val(36),$("#up").val(2.5);}

				if($("#typee").val()==5)
					{$("#interest").val(36),$("#up").val(3.5);}
